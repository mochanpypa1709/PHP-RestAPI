...
class Task {
	...
	private $_completed;
	// define variable to store task images array
	private $_images;
  ...
  // function to return task completed
	...
	// function to return task images
  ...
  // function to set the private task description
	...
	// function to set the private task images array
	public function setImages($images) {
		// if passed in images is not an array
		if(!is_array($images)) {
			throw new TaskException("Task images is not an array");
		}
		$this->_images = $images;
	}
